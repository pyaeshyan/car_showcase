...
export default async function fetchCars(filterProps : FilterProps)
{
    const { manufacturer, year, model, limit, fuel } = filterProps;
    const headers = {
        'x-rapidapi-key': 'f96a48adfcmsh957944fd561baf5p1034e7jsn27824ac49757',
